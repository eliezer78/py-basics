...
# cilindrada y un método informacion() que además de la marca y el modelo, 
# imprima la cilindrada.
#
# Crea un objeto de tipo Auto y otro de tipo Moto, y llama a su método 
# informacion()
