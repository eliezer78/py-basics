...
# donde cada línea contiene el nombre de un estudiante y su nota separados por una coma.
# El programa debe manejar las siguientes excepciones:
# - Si el archivo no existe, debe mostrar un mensaje de error: "Error: El archivo no existe."
# - Si una línea no tiene el formato correcto (nombre, nota), debe mostrar un mensaje de error:
...
print("Fin del programa. Lectura finalizada.")